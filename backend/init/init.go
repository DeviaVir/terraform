...
import (
	...
	backendAtlas "github.com/DeviaVir/terraform/backend/atlas"
	backendLocal "github.com/DeviaVir/terraform/backend/local"
	backendRemote "github.com/DeviaVir/terraform/backend/remote"
	backendArtifactory "github.com/DeviaVir/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/DeviaVir/terraform/backend/remote-state/azure"
	backendConsul "github.com/DeviaVir/terraform/backend/remote-state/consul"
	backendEtcdv2 "github.com/DeviaVir/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/DeviaVir/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/DeviaVir/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/DeviaVir/terraform/backend/remote-state/http"
	backendInmem "github.com/DeviaVir/terraform/backend/remote-state/inmem"
	backendManta "github.com/DeviaVir/terraform/backend/remote-state/manta"
	backendOSS "github.com/DeviaVir/terraform/backend/remote-state/oss"
	backendPg "github.com/DeviaVir/terraform/backend/remote-state/pg"
	backendS3 "github.com/DeviaVir/terraform/backend/remote-state/s3"
	backendSwift "github.com/DeviaVir/terraform/backend/remote-state/swift"
)
